...
- VS3 is covered by translation parsing, provider selection, NBWCode request construction, mocked Camb.ai SDK generation, mocked Camb.ai voice listing, WAV validation, one-segment Camb.ai test generation, per-segment file generation, failure continuation, error log writing, and usage artifact writing.
